...
#include "multibot2_server/global_planner/navfn.hpp"
...
namespace multibot2_server::nav2_navfn_planner
{
...
PLUGINLIB_EXPORT_CLASS(multibot2_server::nav2_navfn_planner::NavfnPlanner, nav2_core::GlobalPlanner)